  ...
  return (
    <>
      ...
      <div className="flex min-h-full flex-1 flex-col items-center justify-evenly">
        <h1 className="font-megrim text-8xl font-normal tracking-widest text-white 2xl:text-9xl">
          <span className="text-red-600">Astro</span>Atlas
        </h1>
        <div className="w-[30rem] 2xl:w-[40rem]">
          <img
            className=""
        ...
        <Link
          className="rounded-full bg-black/75 py-3 px-20 font-mono text-xl tracking-wide text-white 2xl:px-40"
          href="./app"
        >
          Explore
        </Link>
