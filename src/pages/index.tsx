...
const Home: NextPage = () => {
  ...
  return (
    <>
      <HtmlHead />
      <div className="flex min-h-full flex-1 flex-col items-center justify-evenly">
        <h1 className="font-megrim text-4xl font-normal tracking-widest text-white lg:text-6xl xl:text-8xl 2xl:text-9xl">
          <span className="text-red-600">Astro</span>Atlas
        </h1>
        <div className="w-[15rem] lg:w-[20rem] xl:w-[30rem] 2xl:w-[40rem]">
          <img
            className=""
        ...
        <Link
          className="rounded-full bg-black/75 py-3 px-10 font-mono text-xs tracking-wide text-white lg:px-10 xl:px-20 xl:text-xl 2xl:px-40"
          href="./app"
        >
          Explore
        </Link>
